                      ...
                      <div className="outer uk-grid uk-grid-large" data-uk-grid>
                        <div className="inner uk-width-expand uk-first-column">
                          <div className="entry-body">
                            <h3 className="uk-h3 title-light">Business challenges.</h3>
                            <p>
                            ...
                            <h3 className="uk-h3 title-light">Why Grav CMS?</h3>
                            <p>
                            ...
                            <h3 className="uk-h3 title-light">About Bayron Home Improvements Inc.</h3>
                            <p>
                            ...
                            >
                              ...
                              <h3 className="uk-h3 title-light">Brief.</h3>
                              <p>
                              ...
                              <h3 className="uk-h3 title-light">The future.</h3>
                              <p>
