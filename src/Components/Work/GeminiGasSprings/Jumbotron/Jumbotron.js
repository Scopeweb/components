          ...
          <div className="section-inner">
            <div className="hero-content uk-grid uk-grid-stack" data-uk-grid>
              <div className="uk-width-2-3@s uk-first-column">
                ...
                <h1 className="title uk-heading-hero" style={{opacity: 1, transform: 'translateY(0px)'}}>Gemini Gas Springs</h1>
                <p>
                ...
                <p className="uk-margin-large-bottom">No problem though, just <a className="red" href="mailto:info@scopeweb.nyc?Subject=Gemini Gas Springs project information">get in touch</a> and we'll send you some further info about this project.</p>
