          ...
          <div className="section-inner">
            <div className="hero-content uk-grid uk-grid-stack" data-uk-grid>
              <div className="uk-width-2-3@s uk-first-column">
                ...
                <p className="uk-margin-large-bottom">No problem though, just <a className="red" href="mailto:info@scopeweb.nyc?Subject=GoRemote project information">get in touch</a> and we'll send you some further info about this project.</p>
