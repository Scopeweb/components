          ...
          <div className="section-inner">
            <div className="hero-content uk-grid uk-grid-stack" data-uk-grid>
              <div className="uk-width-2-3@s uk-first-column">
                ...
                <h1 className="title uk-heading-hero" style={{opacity: 1, transform: 'translateY(0px)'}}>GoRemote Job Board</h1>
                <p>
                ...
                <p className="uk-margin-large-bottom">We'd love to tell you more, but we are currently re-thinking our website, and our case studies too. Stay tuned! No problem though, just <a className="red" href="mailto:info@scopeweb.nyc?Subject=GoRemote project information">get in touch</a> and we'll send you some further info about this project.</p>
